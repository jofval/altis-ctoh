...
class Time_Series_Panel(wx.Frame):
    ...
    def toYearFraction(self,date):
        ...
        fraction = np.float64(yearElapsed/yearDuration)

        return np.float64(date.year + fraction)
    ...
    def HydroWebexport_L(self):
        ...
        array.append(np.array(['NaN']*nber_meas))
        array.append(np.array(['NaN']*nber_meas))
        array.append(np.array(['NaN']*nber_meas))
        ...
        hydroweb_header=[
            ...
            ["#"],
            ["# surface of reference: The development and evaluation of the Earth Gravitational Model 2008 (EGM2008),"],
            ["# Pavlis, N.K., Holmes, S.A., Kenyon, S.C., Factor, J.K., 2012, J. Geophys. Res. Solid Earth 117,"],
            ...
            ["# reference: Frappart et al., 2021, Remote Sensing 13, no. 11: 2196. https://doi.org/10.3390/rs13112196"],
            ["#"],
            ["# sources: Altimetric GDR data product supplied by CTOH"],
            ["# data policy: http://ctoh.legos.obs-mip.fr/data/data-policy/at_download/file"],
            ["#"],
        ...
        with wx.FileDialog(
            ...
            with open(pathname, 'w') as f:
                ...
                for line in lines:
                    ...
                    nws=13-len(val_list[0])
                    val_list[0]=val_list[0]+'0'*nws
                    nws=8-len(val_list[3])
                    val_list[3]=' '*nws+val_list[3]
                    nws=8-len(val_list[4])
                    val_list[4]=' '*nws+val_list[4]
                    line=" ; ".join(val_list)
                    f.write(line+' ; \n')
